...
export function Layout() {
  ...
  return (
    <div className="min-h-screen">
      {isDemoMode() && (
        <p className="border-b border-amber-200 bg-amber-50 px-4 py-1.5 text-center text-sm text-amber-800">
          Demo mode — a shared sandbox that resets every hour. Explore freely.
        </p>
      )}
